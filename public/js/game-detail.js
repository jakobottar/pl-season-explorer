...
class GameDetail {
    ...
    drawDiv() {
        ...
        svgGroup.append('text').attr('transform', 'translate(240, 90)').text('First half').classed('half-text', true);
        ...
        svgGroup.append('text').attr('transform', 'translate(240, 190)').text('Second half').classed('half-text', true);
    }
